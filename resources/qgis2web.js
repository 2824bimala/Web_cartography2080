...
map.getView().fit([9003402.268164, 3298029.202467, 9040811.217079, 3319246.328137], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Population Density and Road Network</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (79 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows population distribution in Tikapur along with road network data.';
            }

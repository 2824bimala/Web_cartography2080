...
var style_PopulationDensity_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pop_densty");
    var labelText = "";
    size = 0;
    ...
    if (value >= 307.375060 && value <= 392.192256) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 392.192256 && value <= 436.310062) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 436.310062 && value <= 468.000998) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 468.000998 && value <= 728.812692) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 728.812692 && value <= 2135.110420) {
            style = [ new ol.style.Style({
